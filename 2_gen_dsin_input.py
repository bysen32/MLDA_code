...
if __name__ == "__main__":
    ...
    for i in range(FILE_NUM):
        user_hist_session_ = pd.read_pickle(
             SAMP_PATH + '/user_hist_session_' + str(FRAC) + '_dsin_' + str(i) + '.pkl')  # 19,34
